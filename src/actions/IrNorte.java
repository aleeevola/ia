...
public class IrNorte extends SearchAction{
	...
	public SearchBasedAgentState execute(SearchBasedAgentState s) {
        ...
        String esquinaSiguiente = agState.getEsquinas().get(agState.getUbicacionActual()).get(2); //Get(2) porque el orden de las esquinas siguientes es "Este,Oeste,Norte,Sur"
