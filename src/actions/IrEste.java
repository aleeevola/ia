...
public class IrEste extends SearchAction{
	...
	public SearchBasedAgentState execute(SearchBasedAgentState s) {
        ...
        String esquinaSiguiente = agState.getEsquinas().get(agState.getUbicacionActual()).get(0); //Get(0) porque el orden de las esquinas siguientes es "Este,Oeste,Norte,Sur"
