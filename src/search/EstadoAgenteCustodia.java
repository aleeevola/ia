...
public class EstadoAgenteCustodia extends SearchBasedAgentState{
	...
	private void cargarMapa() {
		esquinas.put(new VectorCalles("Almirante Brown","Pedro de Vega"), Arrays.asList(null, new VectorCalles("Almirante Brown","Ricardo Aldao"), new VectorCalles("Echagüe","Pedro de Vega"), null));
		...
		esquinas.put(new VectorCalles("Antonia Godoy","Angel Cassanello"), Arrays.asList(new VectorCalles("Piedras","Angel Cassanello"), new VectorCalles("Patricio Cullen","Angel Cassanello"), null, new VectorCalles("Antonia Godoy","Ricardo Aldao")));
		...
		esquinas.put(new VectorCalles("Dorrego","Pedro de Vega"), Arrays.asList(null, new VectorCalles("General Paz","Ricardo Aldao"), new VectorCalles("Dorrego","Ricardo Aldao"), null));
		...
		esquinas.put(new VectorCalles("General Paz","Angel Cassanello"), Arrays.asList(new VectorCalles("General Paz","Dorrego"), null, new VectorCalles("General Paz","J.P.López"), new VectorCalles("General Paz","Ricardo Aldao")));
		...
		esquinas.put(new VectorCalles("Almirante Brown","Hernandarias"), Arrays.asList(new VectorCalles("Almirante Brown","Juan Castelli"), new VectorCalles("Defensa","Hernandarias"), new VectorCalles("Almirante Brown","Riobamba"), new VectorCalles("Almirante Brown","J.P.López")));
		esquinas.put(new VectorCalles("Almirante Brown","Riobamba"), Arrays.asList(null, null, new VectorCalles("Riobamba","Juan Castelli"), null));
		esquinas.put(new VectorCalles("Almirante Brown","Juan Castelli"), Arrays.asList(null, null, new VectorCalles("Almirante Brown","Estanislao Zeballos"), new VectorCalles("Almirante Brown","Hernandarias")));
		...
		esquinas.put(new VectorCalles("Echagüe","Hernandarias"), Arrays.asList(null, new VectorCalles("Patricio Cullen","Hernandarias"), null, new VectorCalles("Echagüe","J.P. López")));
		...
		esquinas.put(new VectorCalles("Antonia Godoy","Hernandarias"), Arrays.asList(null, new VectorCalles("Piedras","Hernandarias"), null, new VectorCalles("Antonia Godoy","J.P. López")));
		...
		esquinas.put(new VectorCalles("Tacuarí","Hernandarias"), Arrays.asList(null, new VectorCalles("Velez Sarfield","Hernandarias"), null, new VectorCalles("Tacuarí","J.P. López")));
		...
		esquinas.put(new VectorCalles("General Paz","Juan Castelli"), Arrays.asList(null, null, new VectorCalles("General Paz","Estanislao Zeballos"), new VectorCalles("General Paz","Hernandarias")));
		...
		esquinas.put(new VectorCalles("Riobamba","Javier de la Rosa"), Arrays.asList(null, null, new VectorCalles("Riobamba","Regimiento 12 de Infantería"), null));
		...
		esquinas.put(new VectorCalles("Defensa","Javier de la Rosa"), Arrays.asList(null, null, null, new VectorCalles("Defensa","Padre Genesio")));
		...
		esquinas.put(new VectorCalles("Talcahuano","Javier de la Rosa"), Arrays.asList(null, null, new VectorCalles("Talcahuano","Regimiento 12 de Infantería"), null));
		...
		esquinas.put(new VectorCalles("Echagüe","Javier de la Rosa"), Arrays.asList(null, null, null, new VectorCalles("Echagüe","Padre Genesio")));
		...
		esquinas.put(new VectorCalles("Patricio Cullen","Alberti"), Arrays.asList(new VectorCalles("Echagüe","Alberti"), null, new VectorCalles("Patricio Cullen","Cardenal Fasolino"), null));
		...
		esquinas.put(new VectorCalles("Antonia Godoy","Javier de la Rosa"), Arrays.asList(null, null, null, null));
		...
		esquinas.put(new VectorCalles("Piedras","Javier de la Rosa"), Arrays.asList(null, null, new VectorCalles("Piedras","Regimiento 12 de Infantería"), null));
		...
		esquinas.put(new VectorCalles("Tacuarí","Javier de la Rosa"), Arrays.asList(null, null, null, new VectorCalles("Tacuarí","Padre Genesio")));
